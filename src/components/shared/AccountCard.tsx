    ...
    <div className="wrap-sidebar-account">
      <div className="sidebar-account">
        ...
        <ul className="my-account-nav">
          <li>
            <span
              className={`my-account-nav-item ${location.pathname === PATHS.MYACCOUNT && "active"}`}
              onClick={() => navigate(PATHS.MYACCOUNT)}
            >
              <svg
                width="24"
                height="24"
          ...
          <li>
            <a
              onClick={() => navigate(PATHS.MYORDER)}
              className={`my-account-nav-item ${
                (location.pathname === PATHS.MYORDER ||
          ...
          <li>
            <a
              onClick={() => navigate(PATHS.MYADDRESS)}
              className={`my-account-nav-item ${location.pathname === PATHS.MYADDRESS && "active"}`}
            >
              <svg
                width="24"
                height="24"
          ...
          <li>
            <a onClick={handleLogout} className="my-account-nav-item">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
