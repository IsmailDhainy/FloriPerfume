  ...
  return (
    ...
    >
      <div className="relative h-full" ref={dropdownRef}>
        <div
          className={cn(
            "border-neutral-light focus-within:border-primary focus-within:ring-primary/25 flex h-full w-full items-center rounded-md border px-3 py-2 focus-within:ring-1",
            isOpen && "!ring-primary/25 border-transparent ring-2",
          )}
          ...
          <div className="flex flex-1 flex-wrap gap-1">
            {showSelectedOptions &&
              ...
              selectedLabels.map((label, index) => (
                <span
                  key={index}
                  className="border-primary/20 bg-primary-light/60 text-primary inline-flex items-center rounded border px-2 py-1 text-xs"
                >
                  {label}
                  <XIcon
                    className="hover:text-primary ml-1 h-3 w-3 cursor-pointer"
                    onClick={(e) =>
                      removeOption(
            ...
            >
              <input
                ...
                type="text"
                className={cn(
                  "text-accent flex-1 bg-transparent text-sm outline-none",
                  multiple && selectedLabels.length > 0
                    ? "placeholder:text-accent w-auto"
                    : "w-full",
        ...
        {isOpen && (
          <div className="border-neutral-light absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md border bg-white shadow-lg">
            <div ref={optionsRef}>
                ...
                filteredOptions?.map((option, index) => {
                  ...
                  return (
                    <div
                      key={option.value}
                      className={cn(
                        "hover:bg-neutral-light/30 flex cursor-pointer items-center px-3 py-2",
