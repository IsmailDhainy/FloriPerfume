...
import { ProductTableType } from "$/types/native/product.types";

export const ProductsTableHeaders: TableColumn<ProductTableType>[] = [
  {
    selector: "id",
    title: "ID",
    meta: {
