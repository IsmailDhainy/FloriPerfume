...
import { ContactTableType } from "$/types/native/contact.types";

export const ContactTableHeaders: TableColumn<ContactTableType>[] = [
  {
    selector: "id",
    title: "ID",
    meta: {
  ...
  return (
    <>
      ...
      <Flexbox fullWidth className="gap-2.5 rounded-2xl bg-white shadow-2xl">
        <EnhancedTable<ContactTableType>
          ...
          onRowClick={(row) =>
            navigate(PATHS.CONTACT_DETAILS.replace(":id", row.id))
          }
        />
      </Flexbox>
    </>
